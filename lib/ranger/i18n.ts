...
const en = {
  ...
  cBiggestDay: "Biggest day",
  cFastestDay: "Fastest day",
  ...
  // ── Day view (ranger-daily-history) ──
  thDay: "Day",
  thSyncs: "Syncs",
  thCeilPct: "Of ceiling",
  dayOver: "over {w}",
  daySingle: "{n} sync",
  dayPlural: "{n} syncs",
  dayBaseline: "starting snapshot",
  dayFlaggedOf: "{k} of {n} flagged",
  dayHeld: "{k} withheld · −{v}",
  dayAcked: "{k} reviewed OK",
  dayWorst: "worst send {p}%",
  dayEventsTitle: "The {n} sends that made this day",
  daysCount: "{n} day(s)",
  noDays: "No days match this filter.",
  monthLabel: "Period:",
  monthAll: "All",
  monthEmpty:
    "No records in this month for this player. Choose another month, or go back to the full record.",
  monthBack: "Show all",
  chScoped: "Showing {m} only.",
  truncNotice:
    "Showing the most recent {n} changes. Anything earlier is not on this page, and the period picker covers only what was read.",
  wd0: "Sun",
  wd1: "Mon",
  wd2: "Tue",
  wd3: "Wed",
...
const zh: typeof en = {
  ...
  dayPlural: "{n} 笔",
  dayBaseline: "起始快照",
  dayFlaggedOf: "{n} 笔中 {k} 笔可疑",
  dayHeld: "{k} 笔被隔离 · −{v}",
  dayAcked: "{k} 笔已复核",
  dayWorst: "最差单笔 {p}%",
  dayEventsTitle: "这一天的 {n} 笔上传",
  daysCount: "{n} 天",
  noDays: "没有符合这个筛选的日子。",
  monthLabel: "时间段:",
  monthAll: "全部",
  monthEmpty: "这个玩家在这个月没有记录。换一个月,或者回到全部记录。",
  monthBack: "回到全部",
  chScoped: "只显示 {m}。",
  truncNotice: "只显示最近 {n} 条变化。更早的不在这一页上,上面的时间段选择也只覆盖读到的这些。",
  wd0: "周日",
  wd1: "周一",
  wd2: "周二",
  wd3: "周三",
